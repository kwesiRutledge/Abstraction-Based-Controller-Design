...
Hinv = [ Polyhedron('lb',[0,0],'ub',[1,1]) , ...
		 Polyhedron('lb',[1,0],'ub',[2,1]) , ...
		 Polyhedron('lb',[2,0],'ub',[3,1]) , ...
		 Polyhedron('lb',[0,1],'ub',[1,2]) , ...
		 Polyhedron('lb',[1,1],'ub',[2,2]) , ...
		 Polyhedron('lb',[2,1],'ub',[3,2]) , ...
		 Polyhedron('lb',[0,2],'ub',[1,3]) , ...
		 Polyhedron('lb',[1,2],'ub',[2,3]) , ...
...
fcn_start = tic;
ets_out_fcn = st_hscc.KAM( 'MaximumIterations' , max_iter , 'Debug' , true , 'CheckCoverConvergence' , use_convergencecheck )
